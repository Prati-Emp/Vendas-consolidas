#!/usr/bin/env python3
"""
Script para criar a view de forma simples
"""
...
def criar_view_simples(conn):
    """Cria a view de forma simples"""
    print("\n" + "="*60)
    print("CRIANDO VIEW SIMPLES")
    print("="*60)
    
    try:
        # 1. Criar a view diretamente no schema padrão
        print("1. Criando view sienge_vendas_consolidadas...")
...
def main():
    """Funcao principal"""
    print("CRIANDO VIEW SIMPLES COM NOVAS COLUNAS")
    print("="*60)
    ...
    try:
        if not criar_view_simples(conn):
            return False

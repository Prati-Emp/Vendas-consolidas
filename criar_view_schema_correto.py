#!/usr/bin/env python3
"""
Script para criar a view no schema correto informacoes_consolidadas
"""
...
def criar_view_schema_correto(conn):
    """Cria a view no schema correto informacoes_consolidadas"""
    print("\n" + "="*60)
    print("CRIANDO VIEW NO SCHEMA CORRETO")
    print("="*60)
    
    try:
        # 1. Remover view existente se houver
        print("1. Removendo view existente se houver...")
        try:
        ...
        print("\n2. Criando schema informacoes_consolidadas...")
        try:
        ...
        # 3. Criar a view no schema correto
        print("\n3. Criando view no schema informacoes_consolidadas...")
        ...
        print("\n4. Verificando estrutura da view...")
...
def main():
    ...
    try:
        if not criar_view_schema_correto(conn):
            return False
        
        print("\n" + "="*60)
        print("VIEW CRIADA COM SUCESSO NO SCHEMA CORRETO!")
        print("="*60)
        print("A view informacoes_consolidadas.sienge_vendas_consolidadas foi criada com as 3 novas colunas.")

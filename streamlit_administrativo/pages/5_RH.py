"""Página de RH do dashboard de Administrativo."""
...
from dashboard.apps.rh_dashboard import render_rh_dashboard  # noqa: E402

st.set_page_config(
    page_title="Administrativo - RH",
    page_icon="👥",
    layout="wide",
...
require_page_access("administrativo.rh")

st.title("🏛️ Dashboard Administrativo")
render_administrativo_navigation(current_key="rh")

st.markdown("---")

render_rh_dashboard(show_title=False, show_caption=False)

"""Página de Indicadores RH do dashboard de Administrativo."""
...
st.set_page_config(
    page_title="Administrativo - Indicadores RH",
    page_icon="📊",
    layout="wide",
...
require_page_access("administrativo.indicadores_rh")

st.title("🏛️ Dashboard Administrativo")
render_administrativo_navigation(current_key="indicadores_rh")

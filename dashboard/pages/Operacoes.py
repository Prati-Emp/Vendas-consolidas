...
# Permitir importações relativas ao diretório raiz do dashboard
...
# Navegação global e estado da página
display_navigation()
st.session_state["current_page"] = __file__

st.title("⚙️ Dashboard de Operações")
st.caption("Monitoramento das tarefas Jira - Fonte: informacoes_consolidadas.Jira_status_tarefas")
...
def main():
    """Pipeline principal do dashboard."""

...
def render_velocimetro_metas(meta_valor: float, vendas_valor: float, atingimento_percent: float, mes_referencia: str):
    ...
    # Posição no círculo - centro do gauge está aproximadamente em (0.5, 0.60) em coordenadas de papel
    ...
    centro_x = 0.5
    centro_y = 0.60  # Centro do semicírculo do gauge (ajustado para acompanhar melhor o arco)

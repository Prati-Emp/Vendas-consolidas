...
def render_bloco_0():
    ...
    barra_escala_html = f"""
    <div style='margin-top:-182px; position:relative; padding-top:0px; height:300px; display:flex; flex-direction:column; justify-content:flex-start; align-items:center; width:100%;'>

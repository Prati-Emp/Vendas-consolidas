...
def render_bloco_0():
    ...
    with col_principal_dir:
        ...
        barra_escala_html = f"""
        <div style='margin-top:2rem; position:relative; padding-top:10px; height:450px; display:flex; flex-direction:column; justify-content:center;'>
          <div style='position:absolute; top:10px; left:{indicador_posicao}%; transform:translateX(-50%); display:flex; flex-direction:column; align-items:center;'>
          ...
          <div style='position:relative; margin-top:25px; border-radius:14px; overflow:hidden; height:75px; box-shadow:0 0 16px rgba(0,0,0,0.35); max-width:100%; width:100%;'>

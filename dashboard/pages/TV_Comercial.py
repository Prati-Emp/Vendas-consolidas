...
def render_bloco_0():
    ...
    with col_principal_dir:
        ...
        <div style='margin-top:2rem; position:relative; padding-top:0px; height:450px; display:flex; flex-direction:column; justify-content:center;'>
          <div style='position:absolute; top:-20px; left:{indicador_posicao}%; transform:translateX(-50%); display:flex; flex-direction:column; align-items:center;'>
            <div style='font-size:0.85rem;font-weight:700;color:{status_color};margin-bottom:4px;background:rgba(11,11,11,0.85);padding:3px 12px;border-radius:999px;'>{cobertura_percent:.1f}%</div>

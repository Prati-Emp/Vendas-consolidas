#!/usr/bin/env python3
"""
Script para atualizar a view sienge_vendas_consolidadas com as novas colunas:
- vpl_reserva
- vpl_tabela  
- idreserva
"""
...
def atualizar_view_vera_cruz(conn):
    """Atualiza a view Vera Cruz com as novas colunas"""
    print("\n" + "="*60)
    print("ATUALIZANDO VIEW VERA CRUZ")
    print("="*60)
    ...
    try:
        ...
        print("Executando atualizacao da view Vera Cruz...")
        conn.execute(sql_vera_cruz)
        print("View Vera Cruz atualizada com sucesso!")
        
        return True
        
    except Exception as e:
        print(f"ERRO ao atualizar view Vera Cruz: {e}")
        return False

def atualizar_view_principal(conn):
    """Atualiza a view principal com as novas colunas"""
    print("\n" + "="*60)
...
def main():
    """Funcao principal"""
    print("ATUALIZACAO DA VIEW SIENGE_VENDAS_CONSOLIDADAS")
    print("="*60)
    ...
    try:
        ...
        if not verificar_estrutura_atual(conn):
            return False
        
        # 2. Atualizar view Vera Cruz
        if not atualizar_view_vera_cruz(conn):
            return False

#!/usr/bin/env python3
"""
Script para recriar a view completa do zero
"""
...
def recriar_view_completa(conn):
    """Recria a view completa do zero"""
    print("\n" + "="*60)
    print("RECRIANDO VIEW COMPLETA")
    print("="*60)
    ...
    try:
        ...
        try:
            conn.execute("DROP VIEW IF EXISTS informacoes_consolidadas.sienge_vendas_consolidadas")
            print("   View existente removida com sucesso!")
        except Exception as e:
            print(f"   Aviso ao remover view: {e}")
        
        # 2. Criar view nova com as 3 colunas adicionais
        print("\n2. Criando nova view com as 3 colunas adicionais...")
...
def main():
    """Funcao principal"""
    print("RECRIANDO VIEW COMPLETA COM NOVAS COLUNAS")
    print("="*60)
    ...
    try:
        if not recriar_view_completa(conn):
            return False

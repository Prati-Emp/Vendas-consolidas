#!/usr/bin/env python3
"""
Script para criar a view no banco correto informacoes_consolidadas
"""
...
def criar_view_banco_correto(conn):
    """Cria a view no banco correto informacoes_consolidadas"""
    print("\n" + "="*60)
    print("CRIANDO VIEW NO BANCO CORRETO")
    print("="*60)
...
def main():
    ...
    try:
        if not criar_view_banco_correto(conn):
            return False
        
        print("\n" + "="*60)
        print("VIEW CRIADA COM SUCESSO NO BANCO CORRETO!")
        print("="*60)

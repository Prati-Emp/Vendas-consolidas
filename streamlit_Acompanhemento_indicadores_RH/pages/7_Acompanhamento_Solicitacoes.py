"""Página de Acompanhamento de Solicitações do mini-admin RH."""
...
st.set_page_config(
    page_title="Indicadores RH - Acompanhamento de Solicitações",
    page_icon="📋",
    layout="wide",
...
require_page_access("administrativo.acompanhamento_solicitacoes")

...
def get_api_config(api_name: str) -> Optional[APIConfig]:
    ...
    elif api_name == 'cv_assistencias_workflow_tempo':
        return APIConfig(
            name='CV Assistencias Workflow Tempo',
            base_url='https://prati.cvcrm.com.br/api/v1/cvdw/assistencias/workflow/tempo',
            headers={
                'accept': 'application/json',
                'email': os.environ.get('CVCRM_EMAIL', ''),
                'token': os.environ.get('CVCRM_TOKEN', '')
    ...
    elif api_name == 'cv_times_imobiliarias':
        return APIConfig(
            name='CV Times Imobiliárias',
            base_url='https://prati.cvcrm.com.br/api/v2/configuracoes/gestoes-time',
            headers={
                'accept': 'application/json',
                'email': os.environ.get('CVCRM_EMAIL', ''),
                'token': os.environ.get('CVCRM_TOKEN', '')
    ...
    elif api_name == 'cv_corretores':
        return APIConfig(
            name='CV Corretores',
            base_url='https://prati.cvcrm.com.br/api/v1/cadastros/corretores',
            headers={
                'accept': 'application/json',
                'email': os.environ.get('CVCRM_EMAIL', ''),
                'token': os.environ.get('CVCRM_TOKEN', '')
...
def get_all_rate_limits() -> Dict[str, int]:
    ...
    return {
        ...
        'cv_assistencias_workflow_tempo': 60,
        'cv_repasses_workflow': 60,
        'cv_vgv_empreendimentos': 60,
        'cv_comissoes': 60,
        'cv_times_imobiliarias': 60,
        'cv_corretores': 60,

#!/usr/bin/env python3
"""
Script para corrigir a ordem das colunas
"""
...
def corrigir_ordem_colunas(conn):
    """Corrige a ordem das colunas"""
    print("\n" + "="*60)
    print("CORRIGINDO ORDEM DAS COLUNAS")
    print("="*60)
    ...
    try:
        ...
        -- Seção 3: Reservas Vera Cruz (ORDEM CORRIGIDA)
        SELECT
            r.enterpriseId,
...
def main():
    ...
    try:
        if not corrigir_ordem_colunas(conn):
            return False

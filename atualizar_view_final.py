#!/usr/bin/env python3
"""
Script final para atualizar a view principal com as 3 novas colunas
"""
...
def atualizar_view_final(conn):
    """Atualiza a view principal com o número correto de colunas"""
    print("\n" + "="*60)
    print("ATUALIZACAO FINAL DA VIEW PRINCIPAL")
    print("="*60)
    ...
    try:
        ...
        print("Executando atualizacao final da view principal...")
...
def testar_view_final(conn):
    """Testa se a view final funciona corretamente"""
    print("\n" + "="*60)
    print("TESTANDO VIEW FINAL")
    print("="*60)
    ...
    try:
        ...
        print("\n5. Amostra de dados com novas colunas:")
        result = conn.execute("""
            SELECT 
                origem,
                vpl_reserva,
...
def main():
    """Funcao principal"""
    print("ATUALIZACAO FINAL DA VIEW SIENGE_VENDAS_CONSOLIDADAS")
    print("="*60)
    ...
    try:
        # 1. Atualizar view principal
        if not atualizar_view_final(conn):
            return False
        
        # 2. Testar view final
        if not testar_view_final(conn):
            return False
        
        print("\n" + "="*60)
        print("ATUALIZACAO FINAL CONCLUIDA COM SUCESSO!")
        print("="*60)
        print("A view consolidada foi atualizada com as colunas vpl_reserva, vpl_tabela e idreserva.")
        print("Todas as 3 seções agora têm 36 colunas cada.")

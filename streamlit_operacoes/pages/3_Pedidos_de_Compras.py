"""Página dedicada ao dashboard de Pedidos de Compras."""
...
st.set_page_config(
    page_title="Operações - Pedidos de Compras",
    page_icon="⚙️",
    layout="wide",
...
render_operacoes_navigation(current_key="pedidos_compras")

st.markdown("---")
st.subheader("📦 Pedidos de Compras")
